...
const likeRatio = computed(
  () => (likeCount.value / (likeCount.value + dislikeCount.value)) * 100 || 0
);
const dislikeRatio = computed(
  () => (dislikeCount.value / (likeCount.value + dislikeCount.value)) * 100 || 0
);
        ...
        <div class="carousel__item-body">
          ...
          <div class="carousel__item-info">
            ...
            <div class="like-dislike-ratio">
              <div class="like-ratio" :style="{ width: likeRatio + '%' }"></div>
              <div
                class="dislike-ratio"
            ...
            <div class="like-dislike-buttons">
              <button @click="like" class="fine-label">Fine</button>
              <button @click="dislike" class="poor-label">Poor</button>
            </div>
          </div>
        </div>
      </div>
...
<template>
  <div class="wrapper">
    <div class="carousel">
      ...
      >
        <div class="carousel__item-body">
          <div class="carousel__item-head">{{ currentEmoji }}</div>
          <div class="carousel__item-info">
            <p class="title">{{ item.kor_co_nm }}</p>
            <p>{{ item.fin_prdt_nm }}</p>
            <div class="like-dislike-ratio">
...
const currentEmoji = computed(() => {
  return likeRatio.value > dislikeRatio.value ? "🍎" : "🍏";
});
</script>
