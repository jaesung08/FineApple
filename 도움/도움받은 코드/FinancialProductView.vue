...
// filterData2
// depositproduct 와 option 을 연결해서
// term 을 전달받아서,
// 해당 term 을 가진 option 이 있다면, product 를 반환
// 1. 연결
// 2. term 조건
...
//       // options에 list 속성이 있는지 확인
//       const optionList = [];
//       if (d.fin_prdt_cd === option.fin_prdt_cd) {
//         optionList.push(option.save_trm);
//       }
//       if (optionList.length > 0 && optionList.includes(Number(term.value))) {
//         return true;
//       }
//     }
//     return false;
